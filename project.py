...
def main():
    st.title("OWL X WhatsApp MCP Server")
    st.markdown("""
This application demonstrates the integration of the [WhatsApp MCP server](https://github.com/lharries/whatsapp-mcp) with the [Owl multi-agent framework](https://github.com/camel-ai/owl), enabling AI agents to interact with your WhatsApp data.

**Key Features:**
- Access and search your personal WhatsApp messages, including media files.
- Send messages to individuals or groups directly through the app.
- Leverage OWL's multi-agent capabilities to automate complex tasks involving WhatsApp interactions.

Enter your task below and click on **Run Task** to execute the multi-agent process.
""")
